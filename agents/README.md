...
| [`security-compliance-agent.md`](./security-compliance-agent.md) | CEO-agent | Security/audit workers | `garak`, `financial-services`, `alirezarezvani/claude-skills` (reshaped), `crewAI`, `rtk`, `claude-mem`, `headroom`, `Anthropic-Cybersecurity-Skills`, `openhuman` |
...
- Least privilege (`CHARTER.md` §2): every tool grant below is the actual, complete list — nothing implicit, nothing inherited.
